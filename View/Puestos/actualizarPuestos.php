                            ...
                            <div class="p-5">
                                ...
                                <form action="" method="POST" class="user">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" placeholder="id" id="txtId"
                                            name="txtId" maxlenght="50" required
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" placeholder="Descripcion" id="txtDescripcion"
                                            name="txtDescripcion" rows="8" maxlenght="250" required> <?php echo $datosPuesto["Descripcion"] ?> 
                                        </textarea>
                                    </div>
